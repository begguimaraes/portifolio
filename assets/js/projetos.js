      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="assets/images/projects/gerasenha.png"
              alt="Imagem do site Gerador de Senhas."
            />
            <div class="buttons">
              <a href="https://github.com/begguimaraes/Gerador-Senhas" target="_blank" title="Repositório no Github">
                <svg
              ...
              <a href="http://geradorsenhasdev.vercel.app" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
        ...
        <div class="card">
          <h3>Site de Links | Bernardo Guimarães</h3>
          <div class="img-wrapper">
            <img
              src="assets/images/projects/sitelink.png"
            ...
            <a href="https://sitelinksdev.vercel.app" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
        ...
        <div class="card">
          ...
          <p>Calculadora desenvolvida através de página web.</p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          <h3>TwT - Technology with Traduction</h3>
          <div class="img-wrapper">
            <img src="./assets/images/projects/twt.png" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/begguimaraes/TwT---Technology-with-Traduction" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>Página para auxiliar na autonomia de pessoas surdas e deficientes auditivas.</p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          <h3>History Hunters</h3>
          <div class="img-wrapper">
            <img src="./assets/images/projects/historyhunters.png" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/begguimaraes/History-Hunters" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>Projeto de site desenvolvido para trazer mais visibilidade para uma comunidade quilombola.</p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <div class="img-wrapper">
            ...
            <div class="buttons">
              <a href="https://github.com/begguimaraes/portifolio" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
